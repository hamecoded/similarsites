define([
	...
	var BaseView = Backbone.View.extend({
		...
		// config for choosing what to render
		// values: 
		// 'model' (renderModel):default, 
		// 'collection' (renderCollection)
		// 'views' (renderViews) - used mainly for a controller
		renderMothod: 'model',
		_renderMap: {
			model: 'renderModel',
			collection: 'renderCollection',
		...
		render: function(options) {
			var renderMothod = this._renderMap[this.renderMothod];
			return this[renderMothod](options);
		},
